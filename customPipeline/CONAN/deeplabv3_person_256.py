...
parser.add_argument("-nn", "--nn_model", help="select camera input source for inference", default='deeplab_v3_plus_mvn2_decoder_256_openvino_2021.2_6shave.blob', type=str)
